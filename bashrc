...
alias 9_data_test_count='bash test_run data_count';
alias 9_data_test_copy='bash test_run data_copy';
alias 9_data_test_delete='bash test_run data_delete';
alias 9_data_test_delete_search='bash test_run data_many_delete_search';
alias 9_data_test_get='bash test_run data_get';
alias 9_data_test_post='bash test_run data_post';
alias 9_data_test_post_items='bash test_run data_many_post_items';
alias 9_data_test_search='bash test_run data_search';
#
...
alias 9_server_edit="cd ${BIZ9_HOME}biz9-website-data/source;vi -c 'NERDTree'";
alias 9_website_data_start='cd ${BIZ9_HOME}biz9-website-data/source;9_node_mongo_start';
alias 9_website_data='cd ${BIZ9_HOME}biz9-website-data/source';
alias 9_website_data_edit="cd ${BIZ9_HOME}biz9-website-data/source;vi -c 'NERDTree'";
alias 9_website_data_test="cd ${BIZ9_HOME}biz9-website-data/source;vi 'test.js'";
alias 9_website_data_test_data_count="bash test_run data_count";
alias 9_website_data_test_data_copy="bash test_run data_copy";
alias 9_website_data_test_data_delete="bash test_run data_delete";
alias 9_website_data_test_data_delete_search="bash test_run data_many_delete_search";
alias 9_website_data_test_data_get="bash test_run data_get";
alias 9_website_data_test_data_post="bash test_run data_post";
alias 9_website_data_test_data_post_items="bash test_run data_many_post_items";
alias 9_website_data_test_data_search="bash test_run data_search";
alias 9_website_data_test_favorite_delete="bash test_run favorite_delete";
alias 9_website_data_test_favorite_get="bash test_run favorite_get";
alias 9_website_data_test_favorite_user_search="bash test_run favorite_data_user_search";
alias 9_website_data_test_favorite_post="bash test_run favorite_post";
alias 9_website_data_test_review_get="bash test_run review_get";
alias 9_website_data_test_review_delete="bash test_run review_delete";
alias 9_website_data_test_review_post="bash test_run review_post";
alias 9_website_data_test_review_parent_search="bash test_run review_parent_search";
alias 9_website_data_test_store_get_cart="bash test_run store_get_cart";
alias 9_website_data_test_store_delete_cart="bash test_run store_delete_cart";
alias 9_website_data_test_store_get_order="bash test_run store_get_order";
alias 9_website_data_test_store_search_order="bash test_run store_search_order";
alias 9_website_data_test_store_delete_order="bash test_run store_delete_order";
alias 9_website_data_test_store_post_cart="bash test_run store_post_cart";
alias 9_website_data_test_store_post_order="bash test_run store_post_order";
